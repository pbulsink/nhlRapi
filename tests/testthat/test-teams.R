...
test_that("Team pulls team", {
  ...
  expect_error(getTeam(team = 1, modifier = c('bob', 'bad')))
...
test_that('getTeamRoster', {
  ...
  expect_error(getTeamRoster(team = 1, season = c(20172018, 20182019)))
...
test_that('getTeamStats', {
  ...
  expect_error(getTeamStats(team = 1, season = c(20172018, 20182019)))
