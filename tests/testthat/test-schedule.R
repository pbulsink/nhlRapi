...
test_that("Schedule Scraping works", {
  ...
  expect_error(getSchedule(1, scheduleType = c('broadcasts', 'ticket')))
  expect_error(getSchedule(1, scheduleType = 'bad.call'))
  expect_error(getSchedule(1, startDate = 'bad', endDate = 'bad'))
  expect_error(getSchedule(1, startDate = NULL, endDate = '2019-02-28'))
  expect_error(getSchedule(1, startDate = '2019-02-28', endDate = '2018-02-28'))
  expect_error(getSchedule(1, startDate = 'bad', endDate = 'bad'))
